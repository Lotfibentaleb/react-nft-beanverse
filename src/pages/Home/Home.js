...
const CAROUSEL_ITEM_IMAGES = [
	'bean1.png', 'bean2.png', 'bean3.png', 'bean4.png', 'bean5.png',
	'bean6.png', 'bean7.png', 'bean8.png', 'bean9.png', 'bean10.png',
	'bean11.png', 'bean12.png', 'bean13.png', 'bean14.png', 'bean15.png',
]
...
const Home = () => {
  ...
  return (
    <Box className={classes.root}>
		<Box className={classes.banner} id="home">
			...
			<Box textAlign="center">
				...
				<Container maxWidth="md">
					<img className={classes.bannerLogo} src="/images/bean_word_logo.png" alt="banner logo"/>
					<Box mt={1}>
						<Button
							...
							{CAROUSEL_ITEM_IMAGES.map((item) => {
									return (
										<Box className={classes.carouselItem}>
											<Box className={classes.carouselImageBox}><img className={classes.carouselImage} src={'/images/' + item} alt="BEAN" /></Box>
										</Box>
									)
							})}
						</Carousel>
		...
		{/* Roadmap Section */}
		<Box className={classes.id} id="loadmap"></Box>
		<Roadmap />
